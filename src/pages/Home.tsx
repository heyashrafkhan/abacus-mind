  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <StatCard icon={<Star className="w-6 h-6 text-amber-500" />} label="XP Points" value={progress ? progress.xp : 0} color="bg-amber-50 border-amber-200" />
        <StatCard icon={<Trophy className="w-6 h-6 text-accent-purple" />} label="Level" value={progress ? progress.level : 1} color="bg-purple-50 border-purple-200" />
        ...
        <StatCard icon={<BrainCircuit className="w-6 h-6 text-accent-green" />} label="Accuracy" value={`${progress ? progress.accuracy : 0}%`} color="bg-green-50 border-green-200" />
      </div>
